      ...
      child: Consumer<LawViewModel>(
        builder: (context, lawVM, _) {
          final filteredVanBan = _selectedTrangThai == TT_ALL
              ? lawVM.vanBan
              : lawVM.vanBan.where((vb) => vb.trangthai == _selectedTrangThai).toList();
                ...
                : filteredVanBan.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final backgroundColor = index % 2 == 0 ? Colors.white : Colors.grey[100];
                                      ...
                                      child: ElevatedButton.icon(
                                        onPressed: () async {
                                          final result = await Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (_) => AddLawContentScreen(sohieuvanban: vb.sohieu),
                                            ),
                                          );
                                          if (result == true) lawVM.fetchVanBan();
                                        },
                ...
                SizedBox(
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () async {
                      final result = await Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => const AddLawScreen()),
                      );
                      if (result == true) {
                        lawVM.fetchVanBan();
                      }
